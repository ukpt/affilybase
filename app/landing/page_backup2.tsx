    ...
    <main style={{ fontFamily: 'Georgia, serif', maxWidth: '100%', margin: '0' , background: '#F5F2EC', color: '#1a1a1a', minHeight: '100vh' }}>
      ...
      <div style={{ padding: '3rem 1.5rem 0', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '14px', color: '#555', lineHeight: 1.8, maxWidth: '500px', margin: '0 auto 2rem' }}>
          Collaborez avec des crÃ©ateurs, des boutiques partenaires ou vos clients â€” ils recommandent, vous gagnez en visibilitÃ©, vous vendez, ils touchent une commission. Tout le monde gagne.
        </p>
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '2rem' }}>
          ...
          <a href="#demo" style={{ background: 'transparent', color: '#1a1a1a', border: '1px solid #bbb', borderRadius: '6px', padding: '0.75rem 1.5rem', fontSize: '14px', textDecoration: 'none' }}>Voir la dÃ©mo</a>
        </div>
      </div>
      ...
      <div style={{ margin: '0 1.5rem 2rem', border: '0.5px solid #ddd8ce', borderRadius: '10px', overflow: 'hidden', display: 'flex' }}>
        <div style={{ width: '130px', background: '#fff', borderRight: '0.5px solid #ddd8ce', padding: '1rem 0', flexShrink: 0 }}>
          ...
          {['Tableau de bord', 'Mes codes', 'AffiliÃ©s', 'Paiements', 'ParamÃ¨tres'].map((item, i) => (
        ...
        <div style={{ flex: 1, padding: '1rem', background: '#F5F2EC' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '8px', marginBottom: '0.75rem' }}>
            {[['Codes crÃ©Ã©s', '20', '20 actifs'], ['AffiliÃ©s', '20', 'dans votre programme'], ['Ventes gÃ©nÃ©rÃ©es', '1 240â‚¬', 'ce mois']].map(([label, val, sub], i) => (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px' }}>
            {[['STYLE2024', '10%', '20%'], ['PROMO15', '10%', '15%'], ['PARTNER30', '15%', '10%'], ['SUMMER10', '10%', '10%']].map(([code, comm, remise], i) => (
              <div key={i} style={{ background: '#fff', borderRadius: '6px', padding: '0.6rem' }}>
                ...
                <div style={{ fontSize: '8px', color: '#888', display: 'flex', justifyContent: 'space-between', marginBottom: '2px' }}><span>Commission affiliÃ©</span><span>{comm}</span></div>
      ...
      <div style={{ padding: '2rem 1.5rem' }}>
        <span style={{ display: 'inline-block', background: '#d4cfc6', padding: '2px 10px', borderRadius: '4px', fontSize: '12px', fontWeight: 500, marginBottom: '1rem' }}>3 faÃ§ons de l'utiliser</span>
        <h2 style={{ fontSize: '20px', fontWeight: 400, marginBottom: '0.5rem' }}>Un outil, trois stratÃ©gies gagnantes</h2>
        <p style={{ fontSize: '13px', color: '#666', lineHeight: 1.7, marginBottom: '1.5rem' }}>Affilybase s'adapte Ã  votre faÃ§on de vendre.</p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '12px' }}>
          {[
            { title: 'CrÃ©ateurs de contenu', desc: "Donnez un code personnalisÃ© Ã  vos crÃ©ateurs. Ils partagent, leur audience achÃ¨te.", bg: '#e0ede7' },
            { title: 'Boutiques partenaires', desc: 'Collaborez avec des boutiques complÃ©mentaires. Recommandez-vous mutuellement.', bg: '#e8e4f0' },
            { title: 'Vos clients', desc: 'Transformez vos clients satisfaits en ambassadeurs. Le bouche Ã  oreille organisÃ©.', bg: '#faeeda' },
          ].map(({ title, desc, bg }, i) => (
            <div key={i} style={{ background: '#fff', border: '0.5px solid #ddd8ce', borderRadius: '10px', padding: '1.25rem' }}>
              ...
              <span style={{ display: 'inline-block', background: '#d4cfc6', color: '#1a1a1a', fontSize: '11px', padding: '3px 8px', borderRadius: '4px' }}>Commission sÃ©curisÃ©e</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <hr style={{ border: 'none', borderTop: '0.5px solid #ddd8ce' }} />
      <div style={{ padding: '2rem 1.5rem' }}>
        <span style={{ display: 'inline-block', background: '#d4cfc6', padding: '2px 10px', borderRadius: '4px', fontSize: '12px', fontWeight: 500, marginBottom: '1rem' }}>Comment Ã§a marche</span>
        <h2 style={{ fontSize: '20px', fontWeight: 400, marginBottom: '0.5rem' }}>En place en 5 minutes</h2>
        <p style={{ fontSize: '13px', color: '#666', lineHeight: 1.7, marginBottom: '1.5rem' }}>Pas besoin de dÃ©veloppeur. Tout se configure depuis votre dashboard.</p>
        {[
          ['Installez Affilybase sur votre boutique Shopify', 'Connexion en un clic, aucune ligne de code.'],
          ['CrÃ©ez vos codes partenaires', 'Personnalisez le nom, la rÃ©duction et la commission pour chaque partenaire.'],
          ['Vos partenaires partagent, vous vendez', 'Suivez les ventes et les commissions en temps rÃ©el depuis votre dashboard.'],
        ].map(([title, desc], i) => (
      ...
      <div style={{ padding: '2rem 1.5rem' }}>
        ...
        <p style={{ fontSize: '13px', color: '#666', lineHeight: 1.7, marginBottom: '1.5rem' }}>Commencez gratuitement, Ã©voluez selon vos besoins.</p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '10px' }}>
  {[
    { name: 'Free', price: '0â‚¬', period: "1 mois d'essai", features: ['1 code actif', '1 partenaire', 'Dashboard brandÃ©', 'Lien court perso'], excluded: ['Stats avancÃ©es', 'Multi-boutiques', 'Support prioritaire'], popular: false },
    { name: 'Starter', price: '4.99â‚¬', period: 'par mois', features: ['20 codes actifs', '20 partenaires', 'Dashboard brandÃ©', 'Lien court perso', 'Stats avancÃ©es'], excluded: ['Multi-boutiques', 'Support prioritaire'], popular: true },
    { name: 'Pro', price: '9.99â‚¬', period: 'par mois', features: ['50 codes actifs', '50 partenaires', 'Dashboard brandÃ©', 'Lien court perso', 'Stats avancÃ©es'], excluded: ['Multi-boutiques', 'Support prioritaire'], popular: false },
    { name: 'Business', price: '39.99â‚¬', period: 'par mois', features: ['IllimitÃ©', 'Dashboard brandÃ©', 'Lien court perso', 'Stats avancÃ©es', 'Multi-boutiques', 'Support prioritaire'], excluded: [], popular: false },
    ...
    <div key={i} style={{ background: '#fff', border: popular ? '2px solid #1a1a1a' : '0.5px solid #ddd8ce', borderRadius: '10px', padding: '1rem' }}>
      ...
      <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '5px' }}>
        {features.map((f, j) => <li key={j} style={{ fontSize: '11px', color: '#555', display: 'flex', gap: '5px' }}><span style={{ color: '#2D9B6F' }}>âœ“</span>{f}</li>)}
        {excluded.map((f, j) => <li key={j} style={{ fontSize: '11px', color: '#bbb', display: 'flex', gap: '5px' }}><span>âœ—</span>{f}</li>)}
      </ul>
    </div>
  ))}
</div>
      ...
      <div style={{ padding: '2rem 1.5rem' }}>
        ...
        <h2 style={{ fontSize: '20px', fontWeight: 400, marginBottom: '0.5rem' }}>DÃ©jÃ  adoptÃ© par des boutiques Shopify</h2>
        <p style={{ fontSize: '13px', color: '#666', lineHeight: 1.7, marginBottom: '1.5rem' }}>Des premiers rÃ©sultats encourageants.</p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '12px' }}>
          {[['+ 150', 'Boutiques actives'], ['2 500+', 'Ventes gÃ©nÃ©rÃ©es'], ['4.9/5', 'Note moyenne']].map(([val, label], i) => (
      ...
      <div style={{ padding: '2rem 1.5rem' }}>
        ...
        <p style={{ fontSize: '13px', color: '#666', lineHeight: 1.7, marginBottom: '1.5rem' }}>Des boutiques Shopify qui ont boostÃ© leurs ventes grÃ¢ce Ã  leurs partenaires.</p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '12px' }}>
          {[
            { text: "En moins d'une semaine j'avais 5 crÃ©atrices qui partageaient mes produits. Les ventes ont suivi immÃ©diatement.", name: 'Sophie L.', shop: 'Boutique mode â€” Paris', avatarBg: '#1a1a1a', avatarColor: '#fff', initials: 'L' },
            { text: "Affilybase m'a permis de lancer mon programme en 10 minutes. Mes clients fidÃ¨les sont devenus mes meilleurs vendeurs.", name: 'Marc R.', shop: 'Accessoires sport â€” Lyon', avatarBg: '#E8F5F0', avatarColor: '#2D9B6F', initials: 'A' },
            { text: "On collabore avec deux boutiques complÃ©mentaires. On se recommande mutuellement. C'est du gagnant-gagnant.", name: 'Clara B.', shop: 'DÃ©co maison â€” Bordeaux', avatarBg: '#FDF3E3', avatarColor: '#BA7517', initials: 'N' },
            ...
            <div key={i} style={{ background: '#fff', border: '0.5px solid #ddd8ce', borderRadius: '10px', padding: '1.25rem', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <div style={{ color: '#2D9B6F', fontSize: '13px', letterSpacing: '2px' }}>â˜…â˜…â˜…â˜…â˜…</div>
      ...
      <div style={{ padding: '2rem 1.5rem' }}>
        ...
        <h2 style={{ fontSize: '20px', fontWeight: 400, marginBottom: '0.5rem' }}>Questions frÃ©quentes</h2>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          {[
            ...
            ['Comment est-ce que je paye mes partenaires ?', "Affilybase calcule automatiquement les commissions dues. Au moment du versement, vous choisissez librement votre mÃ©thode : virement, PayPal, Lydia ou autre. Vous gardez le contrÃ´le total."],
            ['Mes partenaires peuvent-ils voir leurs commissions en temps rÃ©el ?', "Oui. Chaque partenaire a son propre dashboard avec ses ventes, clics et commissions en temps rÃ©el."],
            ['Puis-je changer de plan Ã  tout moment ?', "Oui, sans engagement ni pÃ©nalitÃ©. Aucune carte bancaire requise pour l'essai gratuit."],
          ].map(([q, a], i) => (
      ...
      <div style={{ padding: '2.5rem 1.5rem', textAlign: 'center', borderTop: '0.5px solid #ddd8ce' }}>
        <h2 style={{ fontSize: '24px', fontWeight: 400, marginBottom: '0.75rem' }}>PrÃªt Ã  <span style={{ background: '#d4cfc6', padding: '2px 10px', borderRadius: '4px' }}>booster vos ventes</span> ?</h2>
        ...
        <a href="/login" style={{ background: '#2D9B6F', color: '#fff', borderRadius: '6px', padding: '0.85rem 1.75rem', fontSize: '14px', fontWeight: 500, textDecoration: 'none' }}>Commencer gratuitement â€” sans engagement</a>
      </div>
      ...
      <div style={{ background: '#1a1a1a', padding: '1.25rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '10px' }}>
        ...
        <div style={{ display: 'flex', gap: '16px' }}>
          {['CGU', 'ConfidentialitÃ©', 'Contact'].map((link, i) => (
            <a key={i} href={`/${link.toLowerCase().replace('Ã©', 'e').replace('Ã ', 'a')}`} style={{ fontSize: '11px', color: '#888', cursor: 'pointer', textDecoration: 'none' }}>{link}</a>
          ))}
        </div>
        <div style={{ fontSize: '11px', color: '#555', width: '100%', textAlign: 'center', marginTop: '8px' }}>Â© 2026 Affilybase â€” Tous droits rÃ©servÃ©s</div>
      </div>
