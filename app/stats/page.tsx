      ...
      <div className="w-52 bg-white border-r border-stone-200 flex flex-col py-5">
        ...
        <nav className="flex flex-col">
          {[
            ...
            <a key={href} href={href} className={`px-5 py-2 text-sm flex items-center gap-2 cursor-pointer hover:text-stone-900 ${label === 'Stats' ? 'font-medium text-stone-900 bg-stone-100 border-l-2 border-stone-900' : 'text-stone-500'}`}>
